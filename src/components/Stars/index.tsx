...
export function Stars() {
    ...
    const backStarsBlinkAnimated = useLoop({ // estrelas atras
        duration: 2000,
        easing: Easing.ease // efeito
    })

    const frontStarsBlinkAnimated = useLoop({// estrelas frente
        duration: 2000,
        easing: Easing.bounce // efeito
    })
    ...
    return (
        <View style={styles.container}>
            <Canvas style={styles.canvas}>
                ...
                >
                    <LinearGradient
                        start={{ x: 222, y: 212 }} // tem que olhar no svg
                        end={{ x: 238, y: 222 }}// tem que olhar no svg
                        colors={[THEME.COLORS.STAR_BLUE, THEME.COLORS.BRAND_LIGHT]}// tem que olhar no svg
                    />
                </Path>
                <Path
                    opacity={backStarsBlinkAnimated}// tem que olhar no svg
